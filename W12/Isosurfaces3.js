...
*/
   ...
   */
	...
	uniforms:{
	    ...
	    colorvalue:{type:'v3',value: new THREE.Color(new THREE.Color().setHex(cmap[isovalue][1]))}
	}
    });
   ...
   // var C = new THREE.Color().setHex(cmap[isovalue][1]);
    ...
    {
	var xloop = volume.resolution.x;
	var yloop = volume.resolution.y;
	var id0 = v0.x + v0.y*xloop + v0.z*xloop*yloop;
	var id1= v1.x + v1.y*xloop + v1.z*xloop*yloop;
	var s0 = volume.values[ id0 ][0];
	var s1 = volume.values[ id1 ][0];
	var t = (s-s0)/(s1-s0);
	var vx = t*(v1.x-v0.x)+v0.x;
	var vy = t*(v1.y-v0.y)+v0.y;
	var vz = t*(v1.z-v0.z)+v0.z;
